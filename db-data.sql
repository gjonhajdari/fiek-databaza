...
("Dardan", "Gashi", "M", "1978-03-10", "Divorced", "Rruga Hasan Prishtina, Peja, Kosovo, 30000", "+9876543210", "dardan@example.com", "dardanG78", "bfc1f66c583c12d5595c3d81e3ee95d07a1b1f0d17e660fb534c243ad76752f0", "profile_picture_3.jpg", "Cooking, Fishing", "Finance, Outdoors", "Detail-oriented numbers enthusiast and nature lover."),
("Vjosa", "Ahmeti", "F", "1995-11-28", "Single", "Rruga Emin Duraku, Prizren, Kosovo, 20000", "+1122334455", "vjosa@example.com", "vjosaA95", "ac9d1e45b2e029bd27c8b9d6ab1d35a31a5f96c6923ad5fbbf28e6a33a66ee1d", "profile_picture_4.jpg", "Gaming, Yoga", "Art, Wellness", "Bringing imagination to life through design."),
("Arben", "Jashari", "M", "1983-09-12", "Married", "Rruga Bajram Kelmendi, Ferizaj, Kosovo, 70000", "+5544332211", "arben@example.com", "arbenJ83", "7d9903a0e9a7001e5d16064ab54cc80268b2a7a7a6c26a42e8cf0a15560c57a3", "profile_picture_5.jpg", "Running, Playing guitar", "Medicine, Music", "Healing with care and strumming melodies."),
("Dafina", "Krasniqi", "F", "1992-06-25", "Single", "Rruga Trepça, Mitrovica, Kosovo, 40000", "+6677889900", "dafina@example.com", "dafinaK", "729c52fb14ffef860fd3da4db1de4c888b8c7c9c0fc9c1bda84edbe6a6de75a9", "profile_picture_6.jpg", "Traveling, Dancing", "Technology, Dance", "Coding, exploring, and dancing my way through life."),
("Burim", "Hoxha", "M", "1975-12-03", "Married", "Rruga B, Pristina, Pristina, Kosovo, 10000", "+2233445566", "burim@example.com", "burimH75", "b9a2e6cc5e4870d1b0e940f378d4c09861cb2b8c46bbf90a53ed4eb69962d670", "profile_picture_7.jpg", "Playing Tennis, Reading", "Law, Literature", "Fighting for justice and enjoying a good book."),
("Aurela", "Aliu", "F", "1998-04-17", "Single", "Rruga Eqrem Qabej, Gjilan, Kosovo, 60000", "+7788990011", "aurela@example.com", "aurelaA", "7b9ab9d44a9f1175ba0c4a4e6cb5d0c31f7eb7b32c7e7f5f8018a2fe1db8a84c", "profile_picture_8.jpg", "Traveling, Photography", "Business, Art", "Marketing maven with an eye for capturing moments."),
("Blerim", "Krasniqi", "M", "1980-07-08", "Divorced", "Rruga Xhemajl Rexha, Prizren, Kosovo, 20000", "+9900887766", "blerim@example.com", "blerimK80", "cb9f1d1b42932a86e8f741128822b041f45b89f18d9e739b5db40d3c73f6b7e1", "profile_picture_9.jpg", "Gardening, Cooking", "Design, Food", "Creating spaces and flavors that inspire."),
("Vesa", "Qorri", "F", "1993-02-22", "Single", "Rruga Eshref Frashëri, Peja, Kosovo, 30000", "+1122334455", "vesa@example.com", "vesaQ", "c3c68b99bebf3899dbb4967e0f99c4ac3842017e9a8e2e3dbf8b97f07910b183", "profile_picture_10.jpg", "Hiking, Writing poetry", "Literature, Nature", "Crafting stories amidst serene trails and verses.");
...
(8, 2, "resume_7.pdf", "2022-11-15 10:10"),
(10, 3, "resume_8.pdf", "2022-12-01 18:25"),
(1, 5, "resume_9.pdf", "2023-01-14 07:05"),
(9, 6, "resume_10.pdf", "2022-12-10 22:30");
