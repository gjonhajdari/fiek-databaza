...
values
("Lirim", "Rexhepi", "M", "1990-05-15", "Married", "Rruga UCK, Pristina, Kosovo, 10000", "+1234567890", "lirim@example.com", "lirimRex90", "5d2e19393cc5a0310c49c5b460b4f3f61b0634ab189ab778de253282ba82c6ad", "profile_picture_1.jpg", "Engineer", "Hiking, Photography", "Technology, Travel", "Passionate about innovation and exploration."),
("Albiona", "Berisha", "F", "1985-08-20", "Single", "Rruga Adem Jashari, Gjakova, Kosovo, 50000", "+1987654321", "albiona@example.com", "albionaB", "2e2a0cc1d178b6348e9354fe1db7965e15d4d7f51cc321f534e4ee7b35eac623", "profile_picture_2.jpg", "Teacher", "Reading, Painting", "Education, Art", "Dedicated to shaping young minds through creativity."),
("Dardan", "Gashi", "M", "1978-03-10", "Divorced", "Rruga Hasan Prishtina, Peja, Kosovo, 30000", "+9876543210", "dardan@example.com", "dardanG78", "bfc1f66c583c12d5595c3d81e3ee95d07a1b1f0d17e660fb534c243ad76752f0", "profile_picture_3.jpg", "Accountant", "Cooking, Fishing", "Finance, Outdoors", "Detail-oriented numbers enthusiast and nature lover."),
("Vjosa", "Ahmeti", "F", "1995-11-28", "Single", "Rruga Emin Duraku, Prizren, Kosovo, 20000", "+1122334455", "vjosa@example.com", "vjosaA95", "ac9d1e45b2e029bd27c8b9d6ab1d35a31a5f96c6923ad5fbbf28e6a33a66ee1d", "profile_picture_4.jpg", "Graphic Designer", "Gaming, Yoga", "Art, Wellness", "Bringing imagination to life through design."),
("Arben", "Jashari", "M", "1983-09-12", "Married", "Rruga Bajram Kelmendi, Ferizaj, Kosovo, 70000", "+5544332211", "arben@example.com", "arbenJ83", "7d9903a0e9a7001e5d16064ab54cc80268b2a7a7a6c26a42e8cf0a15560c57a3", "profile_picture_5.jpg", "Doctor", "Running, Playing guitar", "Medicine, Music", "Healing with care and strumming melodies."),
("Dafina", "Krasniqi", "F", "1992-06-25", "Single", "Rruga Trepça, Mitrovica, Kosovo, 40000", "+6677889900", "dafina@example.com", "dafinaK", "729c52fb14ffef860fd3da4db1de4c888b8c7c9c0fc9c1bda84edbe6a6de75a9", "profile_picture_6.jpg", "Software Engineer", "Traveling, Dancing", "Technology, Dance", "Coding, exploring, and dancing my way through life."),
("Burim", "Hoxha", "M", "1975-12-03", "Married", "Rruga B, Pristina, Pristina, Kosovo, 10000", "+2233445566", "burim@example.com", "burimH75", "b9a2e6cc5e4870d1b0e940f378d4c09861cb2b8c46bbf90a53ed4eb69962d670", "profile_picture_7.jpg", "Lawyer", "Playing Tennis, Reading", "Law, Literature", "Fighting for justice and enjoying a good book."),
("Aurela", "Aliu", "F", "1998-04-17", "Single", "Rruga Eqrem Qabej, Gjilan, Kosovo, 60000", "+7788990011", "aurela@example.com", "aurelaA", "7b9ab9d44a9f1175ba0c4a4e6cb5d0c31f7eb7b32c7e7f5f8018a2fe1db8a84c", "profile_picture_8.jpg", "Marketing Manager", "Traveling, Photography", "Business, Art", "Marketing maven with an eye for capturing moments."),
("Blerim", "Krasniqi", "M", "1980-07-08", "Divorced", "Rruga Xhemajl Rexha, Prizren, Kosovo, 20000", "+9900887766", "blerim@example.com", "blerimK80", "cb9f1d1b42932a86e8f741128822b041f45b89f18d9e739b5db40d3c73f6b7e1", "profile_picture_9.jpg", "Architect", "Gardening, Cooking", "Design, Food", "Creating spaces and flavors that inspire."),
("Vesa", "Qorri", "F", "1993-02-22", "Single", "Rruga Eshref Frashëri, Peja, Kosovo, 30000", "+1122334455", "vesa@example.com", "vesaQ", "c3c68b99bebf3899dbb4967e0f99c4ac3842017e9a8e2e3dbf8b97f07910b183", "profile_picture_10.jpg", "Writer", "Hiking, Writing poetry", "Literature, Nature", "Crafting stories amidst serene trails and verses.");


-- education table data
insert into `application`.`education`(student_id, institution, field_of_study, start_date, end_date, diploma_file, degree, study_area, mentor)
values
...
insert into `application`.`experience`(student_id, title, company_name, job_type, location, start_date, end_date, additional_info)
values
...
-- project table data
insert into `application`.`project`(student_id, project_name, start_date, end_date, institution, location, description, role, web_page)
values
...
-- company table data
insert into `application`.`company`(company_name, logo, email_address, web_page, employee_count, company_type, established_year, address, map_location)
values
...
-- post table data
insert into `application`.`post`(company_id, title, description, required_skills, desired_skills, location, posted_at, application_deadline, like_count)
values
...
values
(2, 1, "2022-03-11 08:45"),
(3, 1, "2022-03-05 15:20"),
(5, 9, "2022-06-08 12:30"),
(5, 10, "2022-08-01 09:15"),
(6, 8, "2022-09-18 17:40"),
(1, 6, "2022-10-08 14:55"),
(8, 2, "2022-11-15 10:10"),
